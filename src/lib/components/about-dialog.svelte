			...
			<div class="space-y-4 text-sm">
				...
				<div class="space-y-1">
					...
					<p class="text-muted-foreground">
						...
						Chaque appartement dispose d'un compte activé par l'administrateur, et peut consulter le
						calendrier, créer et gérer ses réservations en temps réel.
					</p>
				</div>
				...
				<!-- Tech stack -->
				<div class="space-y-2">
					<p class="font-medium">Stack technique</p>
					<ul class="text-muted-foreground space-y-1">
						<li class="flex items-center gap-2">
							<span class="bg-muted rounded px-1.5 py-0.5 font-mono text-xs">SvelteKit</span>
							<span>Framework web (Svelte 5)</span>
						</li>
						<li class="flex items-center gap-2">
							<span class="bg-muted rounded px-1.5 py-0.5 font-mono text-xs">SQLite</span>
							<span>Base de données via Drizzle ORM</span>
						</li>
						<li class="flex items-center gap-2">
							<span class="bg-muted rounded px-1.5 py-0.5 font-mono text-xs">Tailwind v4</span>
							<span>Styles + shadcn-svelte</span>
						</li>
						<li class="flex items-center gap-2">
							<span class="bg-muted rounded px-1.5 py-0.5 font-mono text-xs">Docker</span>
							<span>Déployé via Dokploy</span>
						</li>
					</ul>
				</div>
